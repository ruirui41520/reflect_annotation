...
public class PersonDataBaseActivity extends ListActivity {
    ...
    public void deletePerson(final int id){
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(PersonDataBaseActivity.this)
                .setTitle("是否删除？")
    ...
    public void createDialog(String title,final int action,final int id,final Person mPerson){
        ...
        final View mView = LayoutInflater.from(PersonDataBaseActivity.this).inflate(R.layout.layout_operation, null);
